...
const messages: Record<string, string> = {
  ...
  closed_deal_document_read_only: 'Документ доступен только для просмотра и скачивания: все доступные связанные сделки закрыты.',
  document_relation_company_mismatch: 'Связать можно только документы одной компании.',
  settings_update_conflict: 'Настройки уже изменены другим пользователем. Обновите страницу и повторите попытку.',
  bitrix_administrator_required: 'Назначать управляющих настройками может только администратор Bitrix24.',
